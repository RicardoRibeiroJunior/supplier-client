...
export function AlterSupplierForm(){
    ...
    const {register, handleSubmit, reset} = useForm<FormInputs>({
        ...
        defaultValues: auth.supplier,
    })

    async function handleAlterSupplier(data: FormInputs){
        
        try {
            await auth.updateSupplier(data);
    ...
    return(
        <div>
            <FormContainer>
                ...
                <form onSubmit={handleSubmit(handleAlterSupplier)}>
